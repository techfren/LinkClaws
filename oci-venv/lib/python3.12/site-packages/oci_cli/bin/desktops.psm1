...
function GetOciCommandsToLongParams_desktops() {
    $ociCommandsToLongParams = @{
        ...
        'desktops desktop-pool update' = 'availability-policy boot-volume-size-in-gbs contact-details defined-tags description desktop-pool-id device-policy display-name force freeform-tags from-json help if-match image max-wait-seconds maximum-size session-lifecycle-actions standby-size time-start-scheduled time-stop-scheduled wait-for-state wait-interval-seconds'
