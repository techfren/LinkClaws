...
function GetOciCommandsToLongParams_devops() {
    $ociCommandsToLongParams = @{
        ...
        'devops deploy-environment create-compute-instance-environment' = 'compute-instance-group-selectors defined-tags description display-name freeform-tags from-json help max-wait-seconds project-id security-attributes wait-for-state wait-interval-seconds'
        'devops deploy-environment create-function-environment' = 'defined-tags description display-name freeform-tags from-json function-id help max-wait-seconds project-id security-attributes wait-for-state wait-interval-seconds'
        'devops deploy-environment create-oke-cluster-environment' = 'cluster-id defined-tags description display-name freeform-tags from-json help max-wait-seconds network-channel project-id security-attributes wait-for-state wait-interval-seconds'
        ...
        'devops deploy-environment update' = 'defined-tags description display-name environment-id force freeform-tags from-json help if-match max-wait-seconds security-attributes wait-for-state wait-interval-seconds'
        'devops deploy-environment update-compute-instance-environment' = 'compute-instance-group-selectors defined-tags description display-name environment-id force freeform-tags from-json help if-match max-wait-seconds security-attributes wait-for-state wait-interval-seconds'
        'devops deploy-environment update-function-environment' = 'defined-tags description display-name environment-id force freeform-tags from-json function-id help if-match max-wait-seconds security-attributes wait-for-state wait-interval-seconds'
        'devops deploy-environment update-oke-cluster-environment' = 'cluster-id defined-tags description display-name environment-id force freeform-tags from-json help if-match max-wait-seconds network-channel security-attributes wait-for-state wait-interval-seconds'
