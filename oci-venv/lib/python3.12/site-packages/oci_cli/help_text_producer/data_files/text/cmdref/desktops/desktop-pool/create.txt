...
--are-privileged-users [boolean]

Indicates whether desktop pool users have administrative privileges on
their desktop.
...
--availability-policy [complex type]
...
Contact information of the desktop pool administrator. Avoid entering
confidential information.

--device-policy [complex type]
...
A user friendly description providing additional information about the
...
A list of network security groups for the private access. This is a
...
--private-access-details [complex type]
...
--session-lifecycle-actions [complex type]
...
--use-dedicated-vm-host [text]

Indicates whether the desktop pool uses dedicated virtual machine
hosts.
