...
=====
   ...
   oci db database change-encryption-key-location-azure-encryption-key-details [OPTIONS]


Required Parameters
===================

--azure-encryption-key-id [text]
...
security policies before trying the examples.
       ...
       export azure_encryption_key_id=<substitute-value-of-azure_encryption_key_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/database/change-encryption-key-location-azure-encryption-key-details.html#cmdoption-azure-encryption-key-id
       ...
       oci db database change-encryption-key-location-azure-encryption-key-details --azure-encryption-key-id $azure_encryption_key_id --database-id $database_id
