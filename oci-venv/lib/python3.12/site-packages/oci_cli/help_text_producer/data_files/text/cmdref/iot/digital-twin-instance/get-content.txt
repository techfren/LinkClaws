...
Retrieves the content associated with a digital twin instance
identified by the specified OCID. The content can be retrieved only
when a model is associated with the digital twin instance.


Usage
=====

   oci iot digital-twin-instance get-content [OPTIONS]
...
--should-include-metadata [boolean]

If set to true , digital twin instance metadata is included in the
response.
...
security policies before trying the examples.
       ...
       oci iot digital-twin-instance get-content --digital-twin-instance-id $digital_twin_instance_id
