...
=====
   ...
   oci log-analytics upload upload-otlp-logs [OPTIONS]
...
proto/blob/v1.3.1/examples/logs.json
...
security policies before trying the examples.
       ...
       export file=<substitute-value-of-file> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/log-analytics/upload/upload-otlp-logs.html#cmdoption-file
       export namespace_name=<substitute-value-of-namespace_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/log-analytics/upload/upload-otlp-logs.html#cmdoption-namespace-name
       export opc_meta_loggrpid=<substitute-value-of-opc_meta_loggrpid> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/log-analytics/upload/upload-otlp-logs.html#cmdoption-opc-meta-loggrpid

       oci log-analytics upload upload-otlp-logs --file $file --namespace-name $namespace_name --opc-meta-loggrpid $opc_meta_loggrpid
