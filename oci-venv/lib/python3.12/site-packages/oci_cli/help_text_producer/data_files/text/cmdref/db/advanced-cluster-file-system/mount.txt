...
Mounts the advanced cluster file system to all the virtual machines
within a vmcluster.
...
=====
   ...
   oci db advanced-cluster-file-system mount [OPTIONS]
...
security policies before trying the examples.
       ...
       oci db advanced-cluster-file-system mount --advanced-cluster-file-system-id $advanced_cluster_file_system_id
