...
specified. This field is applicable for both use cases - Restoring
Container Database or Restoring specific Pluggable Database.
...
Restores only the Pluggable Database (if specified) using the inputs
provided in request.
