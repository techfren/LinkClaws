...
Type specific request details to create a service for the Network
...
example parameters with your own.
       ...
       oci network-firewall service create --generate-param-json-input service-details > service-details.json
...
security policies before trying the examples.
       ...
       oci network-firewall service create --network-firewall-policy-id $network_firewall_policy_id --service-details file://service-details.json
