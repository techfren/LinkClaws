...
The name of the availability domain in which the Exadata Database
Storage Vault is located.
...
The user-friendly name for the Exadata Database Storage Vault. The
name does not need to be unique.

--high-capacity-storage-gb [integer]
...
--flash-cache-in-percent [integer]
...
The time zone that you want to use for the Exadata Database Storage
Vault. For details, see Time Zones.
