...
Updates the ServiceList with the given name in the network firewall
policy.
...
Unique name identifier for Service Lists in the scope of Network
Firewall Policy.

--services [complex type]

Collection of service names. This is a complex type whose value must
...
The description of the service list. This field can be used to add
additional info.
