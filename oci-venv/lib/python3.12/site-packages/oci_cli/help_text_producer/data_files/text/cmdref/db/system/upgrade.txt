...
Upgrades the operating system and grid infrastructure of the DB
system.
...
If true, rollback time is updated even if operating system upgrade
...
The retention period, in days, for the snapshot that allows you to
perform a rollback of the upgrade operation. After this number of days
