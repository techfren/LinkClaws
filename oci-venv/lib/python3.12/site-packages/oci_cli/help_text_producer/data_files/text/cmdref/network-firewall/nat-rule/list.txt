...
=====
   ...
   oci network-firewall nat-rule list [OPTIONS]
...
--nat-rule-priority-order [integer]
...
results. This must come from the *opc-next-page* or *opc-prev-page*
...
security policies before trying the examples.
       ...
       oci network-firewall nat-rule list --network-firewall-policy-id $network_firewall_policy_id
