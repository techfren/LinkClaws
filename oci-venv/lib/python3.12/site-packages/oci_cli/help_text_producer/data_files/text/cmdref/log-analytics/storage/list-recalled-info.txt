...
=====
   ...
   oci log-analytics storage list-recalled-info [OPTIONS]
...
order may be provided. Default order for timeDataStarted is
descending. If no value is specified timeDataStarted is default.
...
security policies before trying the examples.
       ...
       export namespace_name=<substitute-value-of-namespace_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/log-analytics/storage/list-recalled-info.html#cmdoption-namespace-name

       oci log-analytics storage list-recalled-info --namespace-name $namespace_name
