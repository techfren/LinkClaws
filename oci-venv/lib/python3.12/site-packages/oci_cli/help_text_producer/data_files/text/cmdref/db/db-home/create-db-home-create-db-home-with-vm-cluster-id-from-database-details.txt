"create-db-home-create-db-home-with-vm-cluster-id-from-database-details"
************************************************************************
...
Creates a new Database Home in the specified database system based on
the request parameters you provide. Applies to bare metal DB systems,
Exadata systems, and Exadata Cloud@Customer systems.


Usage
=====

   oci db db-home create-db-home-create-db-home-with-vm-cluster-id-from-database-details [OPTIONS]
...
example parameters with your own.
       ...
       oci db db-home create-db-home-create-db-home-with-vm-cluster-id-from-database-details --generate-param-json-input database > database.json
...
security policies before trying the examples.
       ...
       export vm_cluster_id=<substitute-value-of-vm_cluster_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/db-home/create-db-home-create-db-home-with-vm-cluster-id-from-database-details.html#cmdoption-vm-cluster-id

       oci db db-home create-db-home-create-db-home-with-vm-cluster-id-from-database-details --database file://database.json --vm-cluster-id $vm_cluster_id
