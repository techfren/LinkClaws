...
Gets a list of all On-demand uploads. To use this and other API
...
ascending. If no value is specified timeUpdated is default.
...
Use this for filtering uploads w.r.t warnings. Only one value is
allowed. If no value is specified then ALL is taken as default, which
means that all the uploads with and without warnings will be returned.
