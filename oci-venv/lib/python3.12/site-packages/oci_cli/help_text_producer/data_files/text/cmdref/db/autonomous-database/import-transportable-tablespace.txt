...
Imports transportable tablespace for the specified Autonomous AI
Database.
...
=====
   ...
   oci db autonomous-database import-transportable-tablespace [OPTIONS]
...
URL for OCI Storage location for a Transportable Tablespace (TTS)
bundle.
...
security policies before trying the examples.
       ...
       export tts_bundle_url=<substitute-value-of-tts_bundle_url> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/autonomous-database/import-transportable-tablespace.html#cmdoption-tts-bundle-url
       ...
       oci db autonomous-database import-transportable-tablespace --autonomous-database-id $autonomous_database_id --tts-bundle-url $tts_bundle_url
