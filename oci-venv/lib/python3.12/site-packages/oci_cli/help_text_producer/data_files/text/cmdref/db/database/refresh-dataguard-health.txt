...
Refreshes the Data Guard health status for the specified database.
This operation is supported on both primary and standby databases.


Usage
=====

   oci db database refresh-dataguard-health [OPTIONS]
...
security policies before trying the examples.
       ...
       oci db database refresh-dataguard-health --database-id $database_id
