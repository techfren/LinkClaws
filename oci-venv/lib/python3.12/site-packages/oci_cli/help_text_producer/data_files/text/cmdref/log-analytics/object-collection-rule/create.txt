...
Log Analytics entity OCID. Associates the processed logs with the
...
--is-force-historic-collection [boolean]

Flag to allow historic collection if poll period overlaps with
...
propeties for override are: logSourceName, charEncoding, entityId.
Supported matchType for override are “contains”. This is a complex
...
HISTORIC_LIVE, which will be used by Log Analytics while creating
...
security policies before trying the examples.
       ...
       oci log-analytics object-collection-rule create --compartment-id $compartment_id --log-group-id $log_group_id --name $name --namespace-name $namespace_name --os-bucket-name $os_bucket_name --os-namespace $os_namespace
