...
Lists the advanced cluster file system resources in the specified
compartment.
...
=====
   ...
   oci db advanced-cluster-file-system list [OPTIONS]
...
A filter to return only ACFS that match the given vm cluster id
exactly.
...
security policies before trying the examples.
       ...
       export compartment_id=<substitute-value-of-compartment_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/advanced-cluster-file-system/list.html#cmdoption-compartment-id

       oci db advanced-cluster-file-system list --compartment-id $compartment_id
