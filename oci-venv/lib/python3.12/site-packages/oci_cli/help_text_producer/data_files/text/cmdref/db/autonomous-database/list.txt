...
Gets a list of Autonomous AI Databases based on the query parameters
specified.
...
A filter to return only Autonomous AI Database resources that match
the specified dbVersion.

--db-workload [text]

A filter to return only Autonomous AI Database resources that match
the specified workload type.
...
The database OCID of the resourcepool Leader Autonomous AI Database.
