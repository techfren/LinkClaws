...
=====
   ...
   oci db advanced-cluster-file-system get [OPTIONS]
...
security policies before trying the examples.
       ...
       oci db advanced-cluster-file-system get --advanced-cluster-file-system-id $advanced_cluster_file_system_id
