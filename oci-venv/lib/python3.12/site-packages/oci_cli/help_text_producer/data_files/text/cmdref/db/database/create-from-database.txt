...
The display name of the database to be created. It must begin with an
...
--point-in-time-recovery-timestamp [text]

The point in time of the original database from which the new database
is created. If not specifed, the latest backup is used to create the
database.
...
security policies before trying the examples.
       ...
       oci db database create-from-database --admin-password $admin_password --database-id $database_id
