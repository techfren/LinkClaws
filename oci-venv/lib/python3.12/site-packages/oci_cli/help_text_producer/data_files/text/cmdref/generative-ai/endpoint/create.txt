...
WorkRequest that tracks the endpoint creation progress.
...
--dedicated-ai-cluster-id [text]

The OCID of the dedicated AI cluster on which a model will be deployed
to.
