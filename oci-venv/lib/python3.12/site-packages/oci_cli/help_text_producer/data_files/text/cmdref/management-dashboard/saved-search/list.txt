...
Returned properties are the summary.
...
--compartment-id-in-subtree [text]

This parameter applies only when compartmentId is root compartment.
When set to true, all accessible resources will be returned. Default
is false.
...
The page token representing the page on which to start retrieving
