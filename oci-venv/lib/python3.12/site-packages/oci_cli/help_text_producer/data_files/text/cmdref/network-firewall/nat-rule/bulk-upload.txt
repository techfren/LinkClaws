...
=====
   ...
   oci network-firewall nat-rule bulk-upload [OPTIONS]


Required Parameters
===================

--bulk-upload-nat-rules-details [complex type]

Request Details to bulk import nat rules for the Network Firewall
Policy resource.
...
example parameters with your own.
       ...
       oci network-firewall nat-rule bulk-upload --generate-param-json-input bulk-upload-nat-rules-details > bulk-upload-nat-rules-details.json
...
security policies before trying the examples.
       ...
       oci network-firewall nat-rule bulk-upload --bulk-upload-nat-rules-details file://bulk-upload-nat-rules-details.json --network-firewall-policy-id $network_firewall_policy_id
