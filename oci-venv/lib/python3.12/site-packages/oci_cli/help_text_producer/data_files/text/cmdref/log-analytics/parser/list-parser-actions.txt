...
Returns a list of parser actions. You may limit the number of results
and provide sorting order.


Usage
=====

   oci log-analytics parser list-parser-actions [OPTIONS]
...
security policies before trying the examples.
       ...
       export namespace_name=<substitute-value-of-namespace_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/log-analytics/parser/list-parser-actions.html#cmdoption-namespace-name

       oci log-analytics parser list-parser-actions --namespace-name $namespace_name
