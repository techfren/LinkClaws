...
Type specific request details to create a mapped secret for the
...
example parameters with your own.
       ...
       oci network-firewall mapped-secret create --generate-param-json-input mapped-secret-details > mapped-secret-details.json
...
security policies before trying the examples.
       ...
       oci network-firewall mapped-secret create --mapped-secret-details file://mapped-secret-details.json --network-firewall-policy-id $network_firewall_policy_id --source $source
