...
=====
   ...
   oci network-firewall nat-rule create [OPTIONS]
...
Type specific request details to create a nat rule for the Network
...
example parameters with your own.
       ...
       oci network-firewall nat-rule create --generate-param-json-input nat-rule-details > nat-rule-details.json
...
security policies before trying the examples.
       ...
       export type=<substitute-value-of-type> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network-firewall/nat-rule/create.html#cmdoption-type
       ...
       oci network-firewall nat-rule create --nat-rule-details file://nat-rule-details.json --network-firewall-policy-id $network_firewall_policy_id --type $type
