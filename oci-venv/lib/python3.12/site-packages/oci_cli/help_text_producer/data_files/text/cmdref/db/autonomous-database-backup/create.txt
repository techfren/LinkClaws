...
Creates a new Autonomous AI Database backup for the specified database
...
--backup-destination-details [complex type]
...
The user-friendly name for the backup. The name does not have to be
unique.
