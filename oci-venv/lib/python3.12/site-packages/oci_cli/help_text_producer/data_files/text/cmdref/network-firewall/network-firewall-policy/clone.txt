...
Clones a NetworkFirewallPolicy resource from an existing Network
Firewall Policy. When provided, If-Match is checked against ETag
...
The description of the network firewall policy. This field can be used
to add additional info.

--display-name [text]

A user-friendly optional name for the cloned firewall policy. Avoid
