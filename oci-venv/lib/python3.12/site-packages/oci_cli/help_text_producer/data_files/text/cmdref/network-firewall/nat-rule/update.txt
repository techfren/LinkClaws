...
Updates the NAT rule with the given name in the Network Firewall
policy.
...
=====
   ...
   oci network-firewall nat-rule update [OPTIONS]


Required Parameters
===================

--nat-rule-details [complex type]

Type specific details to update a nat rule for the Network Firewall
Policy resource.
...
Description of a NAT rule. This field can be used to add additional
info.
...
example parameters with your own.
       ...
       oci network-firewall nat-rule update --generate-param-json-input nat-rule-details > nat-rule-details.json
...
security policies before trying the examples.
       ...
       export nat_rule_name=<substitute-value-of-nat_rule_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network-firewall/nat-rule/update.html#cmdoption-nat-rule-name
       ...
       oci network-firewall nat-rule update --nat-rule-details file://nat-rule-details.json --nat-rule-name $nat_rule_name --network-firewall-policy-id $network_firewall_policy_id
