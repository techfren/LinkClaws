...
Checks if the specified input contains valid extended field
definitions against the provided example content.
...
An array of categories assigned to this source. The isSystem flag
