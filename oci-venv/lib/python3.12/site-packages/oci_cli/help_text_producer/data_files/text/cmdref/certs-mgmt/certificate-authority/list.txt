...
*FilterByCertificateAuthorityIdQueryParam* to limit the results to a
single item that matches the specified CA.
...
The OCID of the certificate authority (CA). If the parameter is set to
null, the service lists all CAs.

--compartment-id, -c [text]

A filter that returns only resources that match the given compartment
OCID.
...
order for *EXPIRATIONDATE* and ‘TIMECREATED’ is descending. The
