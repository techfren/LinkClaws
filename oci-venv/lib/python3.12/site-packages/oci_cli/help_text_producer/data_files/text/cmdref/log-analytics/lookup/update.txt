...
Updates the metadata of the specified lookup, such as the lookup
description.
...
An array of categories to assign to the lookup. Specifying the name
...
LogAnalyticsLookupFields.  For documentation on
LogAnalyticsLookupFields please see our API reference: https://docs.c
loud.oracle.com/api/#/en/loganalytics/20200601/datatypes/LogAnalytics
LookupFields. This is a complex type whose value must be valid JSON.
