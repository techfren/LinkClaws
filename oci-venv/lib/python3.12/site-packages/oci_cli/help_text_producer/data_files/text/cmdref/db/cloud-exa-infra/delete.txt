...
Deletes the cloud Exadata infrastructure resource. Applies to Exadata
...
--is-delete-vm-clusters [boolean]

If *true*, forces the deletion the specified cloud Exadata
infrastructure resource as well as all associated VM clusters. If
*false*, the cloud Exadata infrastructure resource can be deleted only
if it has no associated VM clusters. Default value is *false*.
