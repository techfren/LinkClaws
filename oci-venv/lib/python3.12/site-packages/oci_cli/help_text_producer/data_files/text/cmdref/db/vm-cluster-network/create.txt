...
Creates the VM cluster network. Applies to Exadata Cloud@Customer
instances only. To create a cloud VM cluster in an Exadata Cloud
Service instance, use the CreateCloudVmCluster operation.
...
The SCAN details. This is a complex type whose value must be valid
...
Details of the client and backup networks. This is a complex type
