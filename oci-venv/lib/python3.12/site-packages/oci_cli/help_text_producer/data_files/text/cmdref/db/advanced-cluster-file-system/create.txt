...
=====
   ...
   oci db advanced-cluster-file-system create [OPTIONS]
...
The user-friendly name for the Advanced cluster file system. The name
has to be unique.
...
security policies before trying the examples.
       ...
       oci db advanced-cluster-file-system create --name $name --storage-in-gbs $storage_in_gbs --vm-cluster-id $vm_cluster_id
