...
Get a NAT rule by the given name in the context of Network Firewall
policy.
...
=====
   ...
   oci network-firewall nat-rule get [OPTIONS]
...
security policies before trying the examples.
       ...
       export nat_rule_name=<substitute-value-of-nat_rule_name> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/network-firewall/nat-rule/get.html#cmdoption-nat-rule-name
       ...
       oci network-firewall nat-rule get --nat-rule-name $nat_rule_name --network-firewall-policy-id $network_firewall_policy_id
