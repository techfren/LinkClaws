...
This operation updates the cross-region disaster recovery (DR) details
of the standby Autonomous AI Database Serverless database, and must be
run on the standby side.
...
Indicates the disaster recovery (DR) type of the Autonomous AI
...
would set a snapshot standby database back to regular standby
database.
