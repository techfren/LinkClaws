...
present, Log Analytics performs an integrity check on the body of the
HTTP request by computing the MD5 hash for the body and comparing it
to the MD5 hash supplied in the header. If the two hashes do not
...
security policies before trying the examples.
       ...
       oci log-analytics upload upload-log-file --file $file --filename $filename --log-source-name $log_source_name --namespace-name $namespace_name --opc-meta-loggrpid $opc_meta_loggrpid
