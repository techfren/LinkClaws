...
The OCID of the Cloud resource which this entity is a representation
of. This may be blank when the entity represents a non-cloud resource
that the customer may have on their premises.
...
This would be the output one would get if they run *echo $HOSTNAME* on
Linux or an equivalent OS command. This may be different from
...
The name/value pairs for parameter values to be used in file patterns
specified in log sources. This is a complex type whose value must be
...
This indicates the type of source. It is primarily for Enterprise
Manager Repository ID.

--time-last-discovered [datetime]

The date and time the resource was last discovered, in the format
defined by RFC3339.
