...
Gets detailed information about the specified ingest time rule such as
...
Unique ocid of the ingest time rule. Ingest time rule ID can be
obtained by running ‘oci log-analytics ingest-time-rule list
–namespace-name <namespace> –compartment-id <compartment>’. The json
output ‘id’ parameter value contains the rule ID.
