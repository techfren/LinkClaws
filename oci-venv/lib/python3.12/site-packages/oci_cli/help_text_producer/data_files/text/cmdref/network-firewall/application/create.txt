...
Type specific request details to create an application for the Network
...
example parameters with your own.
       ...
       oci network-firewall application create --generate-param-json-input application-details > application-details.json
...
security policies before trying the examples.
       ...
       oci network-firewall application create --application-details file://application-details.json --network-firewall-policy-id $network_firewall_policy_id
