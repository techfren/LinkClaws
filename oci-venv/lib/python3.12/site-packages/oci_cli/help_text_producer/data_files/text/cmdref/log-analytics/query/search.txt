...
Query to perform. Must conform to log analytics querylanguage syntax.
Syntax errors will be returned if present.
...
List of variables to be prepended to the query string. This is a
