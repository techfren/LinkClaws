...
Type specific request details to create a tunnel inspection rule for
the Network Firewall Policy resource.
...
example parameters with your own.
       ...
       oci network-firewall tunnel-inspection-rule create --generate-param-json-input tunnel-inspection-rule-details > tunnel-inspection-rule-details.json
...
security policies before trying the examples.
       ...
       oci network-firewall tunnel-inspection-rule create --network-firewall-policy-id $network_firewall_policy_id --protocol $protocol --tunnel-inspection-rule-details file://tunnel-inspection-rule-details.json
