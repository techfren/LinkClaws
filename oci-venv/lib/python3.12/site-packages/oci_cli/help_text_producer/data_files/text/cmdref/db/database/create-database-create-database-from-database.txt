...
=====
   ...
   oci db database create-database-create-database-from-database [OPTIONS]
...
example parameters with your own.
       ...
       oci db database create-database-create-database-from-database --generate-param-json-input database > database.json
...
security policies before trying the examples.
       ...
       oci db database create-database-create-database-from-database --database file://database.json --db-home-id $db_home_id
