...
A flag indicating whether or not to return the total number of items
returned.

--life-cycle-state [text]

The life cycle state used for filtering.  Only associations with the
specified life cycle state will be returned.
