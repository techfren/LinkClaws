...
=====
   ...
   oci db cloud-vm-cluster unregister-cloud-vm-cluster-pkcs [OPTIONS]
...
security policies before trying the examples.
       ...
       export tde_key_store_type=<substitute-value-of-tde_key_store_type> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/cloud-vm-cluster/unregister-cloud-vm-cluster-pkcs.html#cmdoption-tde-key-store-type
       ...
       oci db cloud-vm-cluster unregister-cloud-vm-cluster-pkcs --cloud-vm-cluster-id $cloud_vm_cluster_id --tde-key-store-type $tde_key_store_type
