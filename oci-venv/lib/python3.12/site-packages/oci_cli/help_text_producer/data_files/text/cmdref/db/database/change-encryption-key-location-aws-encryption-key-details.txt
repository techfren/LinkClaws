...
=====
   ...
   oci db database change-encryption-key-location-aws-encryption-key-details [OPTIONS]


Required Parameters
===================

--aws-encryption-key-id [text]
...
security policies before trying the examples.
       ...
       export aws_encryption_key_id=<substitute-value-of-aws_encryption_key_id> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/database/change-encryption-key-location-aws-encryption-key-details.html#cmdoption-aws-encryption-key-id
       ...
       oci db database change-encryption-key-location-aws-encryption-key-details --aws-encryption-key-id $aws_encryption_key_id --database-id $database_id
