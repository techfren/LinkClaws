...
Creates a new application virtual IP (VIP) address in the specified
cloud VM cluster based on the request parameters you provide.
...
The OCID of the cloud VM cluster associated with the application
...
The OCID of the subnet associated with the application virtual IP
(VIP) address.
...
The OCID of the DB node associated with the application virtual IP
(VIP) address.
