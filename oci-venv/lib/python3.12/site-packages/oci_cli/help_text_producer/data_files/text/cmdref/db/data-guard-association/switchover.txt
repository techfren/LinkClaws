...
Performs a switchover to transition the primary database of a Data
Guard association into a standby role. The standby database associated
with the *dataGuardAssociationId* assumes the primary database role.
