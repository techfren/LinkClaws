...
Unmounts the advanced cluster file system from all the virtual
machines within a vmcluster.


Usage
=====

   oci db advanced-cluster-file-system unmount [OPTIONS]


Required Parameters
===================

--advanced-cluster-file-system-id [text]
...
--wait-for-state" AVAILABLE "--wait-for-state" DELETING would return
...
security policies before trying the examples.
       ...
       export storage_in_gbs=<substitute-value-of-storage_in_gbs> # https://docs.cloud.oracle.com/en-us/iaas/tools/oci-cli/latest/oci_cli_docs/cmdref/db/advanced-cluster-file-system/create.html#cmdoption-storage-in-gbs
       ...
       advanced_cluster_file_system_id=$(oci db advanced-cluster-file-system create --name $name --storage-in-gbs $storage_in_gbs --vm-cluster-id $vm_cluster_id --query data.id --raw-output)

       oci db advanced-cluster-file-system unmount --advanced-cluster-file-system-id $advanced_cluster_file_system_id
