...
by information such as parser name, type, display name and
description.
...
The parser display text used for filtering.  Only parsers with the
...
The source type used for filtering.  Only parsers associated with a
source of the specified type will be returned.
