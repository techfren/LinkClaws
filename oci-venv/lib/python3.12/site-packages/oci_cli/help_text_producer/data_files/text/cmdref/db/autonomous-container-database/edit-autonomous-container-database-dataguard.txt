...
Modify Autonomous Container Database Data Guard settings such as
protection mode, automatic failover, and fast start failover lag
limit. For more information, see Update Autonomous Container Database
Dataguard.
