...
var ForwardMessageParams = z.object({
  inboxId: InboxIdSchema,
  messageId: MessageIdSchema,
  to: z.array(z.string()).describe("Recipients to forward to"),
  cc: z.array(z.string()).optional().describe("CC recipients"),
  bcc: z.array(z.string()).optional().describe("BCC recipients"),
  text: z.string().optional().describe("Additional plain text to include"),
  html: z.string().optional().describe("Additional HTML to include"),
  labels: z.array(z.string()).optional().describe("Labels")
});
...
//# sourceMappingURL=chunk-FG6GNX6W.js.map